...
function activate(context) {
	...
	let whatever = vscode.commands.registerCommand('helloworld.time', function () {
	
			var d = new Date();
			var hours = d.getHours();
			var minutes = d.getMinutes();
			// Display a message box to the user
			vscode.window.showInformationMessage('Current time is '+ hours + ":" + minutes );
		});
...
// this method is called when your extension is detimed
function deactivate() {}
